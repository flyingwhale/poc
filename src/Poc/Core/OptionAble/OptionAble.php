 ...
 */
/**
 * Utilizing this class the developer has got the possibility to pass an array
 * of
 * variables to a class (that implements the OptionAbleInterface Interface) and
 * the
 * class will extract the parameters from it.
 * If the user did not provide all
...
class OptionAble extends \Pimple
{
     ...
     *
     * @param $options array
     * @param $optios OptionAbleInterface
     *
     * @throws \Exception
     */
    public function __construct ($options, $optionAbleInterface)
    {
    ...
    public function start ()
    {
        ...
        if (is_array($this->options)) {
            ...
            throw new \Exception(
                    'Please add an array or null to the
          $options parameter');
        }
    }
