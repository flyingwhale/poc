...
class ModelManager
{
    ...
    public function truncateTable ()
    {
        ...
        if ($this->hasQuery($queryName)) {
            $dbh = $this->getDbHandler();
            $query = sprintf($this->getQuery($queryName), $this->getTableName());
            $sth = $dbh->prepare($query);
            $sth->execute();
    ...
    {
        $query = sprintf($this->getQuery('findBy'), $this->getTableName(),
                $fieldName, $fieldName);
    ...
    {
        $query = sprintf($this->getQuery('findOneBy'), $this->getTableName(),
                $fieldName, $fieldName);
    ...
    public function delete ($id)
    {
        ...
        $query = sprintf($this->getQuery('delete'), $this->getTableName(),
                $fieldName, $fieldName);
    ...
    protected function __save ($model)
    {
        ...
        $query = sprintf($query, $this->getTableName(), $fieldNamesString,
                $valueNamesString);
